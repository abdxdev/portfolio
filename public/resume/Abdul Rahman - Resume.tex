...
\createpointblock{10x Pretender\href{https://github.com/abdxdev/10x-Pretender}{}}{}
{Tech Stack: TypeScript, VSCode API}{}
    {%
        \item Built a VSCode extension to make you look like a coding genius by simulating realistic typing from your clipboard.
    }

    \vspace{0.2 cm}

    \createpointblock{AI LaTeX Helper\href{https://github.com/abdxdev/AI-LaTeX-Helper}{}}{}
    {Tech Stack: TypeScript, VSCode API, Gemini}{}
    {%
    \item Developed a VSCode extension to assist users in writing LaTeX documents using AI-based suggestions.
    }
    
    \vspace{0.2 cm}
    
    \createpointblock{Context Menu Plugin Manager\href{https://github.com/abdxdev/Context-Menu-Plugin-Manager}{}}{}
    ...
    \createpointblock{Terminal Based Rich Text Editor\href{https://github.com/abdxdev/Terminal-Based-Rich-Text-Editor}{}}{}
    {Tech Stack: C++}{}
    {%
        \item Built a C++ application to edit rich text files in the terminal with features like syntax highlighting and formatting.
    }

    \vspace{0.2 cm}

    \createpointblock{Automated Menu Ordering System\href{https://github.com/abdxdev/Automated-Menu-Ordering-System}{}}{}
    ...
    % \createpointblock{Google Classroom Notifications System\href{https://github.com/abdxdev/Google_Classroom_API}{}}{}
    ...
    % \createpointblock{Prize Bond Finder\href{https://github.com/abdxdev/prize-bond-finder}{}}{}
    ...
    % \createpointblock{Student Management System\href{https://github.com/abdxdev/LMS-Semester-Project}{}}{}
    % {Tech Stack: C++}{}
    % {%
    ...
    % \createpointblock{Car Rental Management System\href{https://github.com/abdxdev/Car-Rental-Management-System}{}}{}
    % {Tech Stack: C++}{}
    % {%
